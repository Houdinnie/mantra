...
export const VENTUREMIND_SKILLS = [
  {
    id: "find-community",
    name: "Find Community",
    description: "Identify and evaluate communities to build a minimalist business around",
  ...
  },
  {
    id: "validate-idea",
    name: "Validate Idea",
    description: "Test if a business idea is worth pursuing before building anything",
