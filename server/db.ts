...
export async function getUserStats(userId: number) {
  ...
  // Performance optimization: Use SQL aggregate functions instead of fetching all rows
  // This reduces memory overhead and network transfer as the number of sessions grows.
