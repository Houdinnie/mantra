...
export async function getUserStats(userId: number) {
  ...
  // Optimized: use SQL aggregates to avoid fetching all sessions into memory.
  // This reduces the data transfer and aggregation time from O(N) to O(1) in the app layer.
