...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregate functions to avoid fetching all sessions into memory.
  // This reduces memory usage and network transfer for users with many chat sessions.
