...
/**
 * Used for dependency injection in tests to bypass real DB connection.
 */
...
/**
 * Optimized user stats retrieval using SQL aggregates.
 * Reduces data transfer and memory overhead from O(N) to O(1).
 */
