...
export async function getUserStats(userId: number) {
  ...
  // Optimization: Use SQL aggregates to calculate stats in the database
  // This avoids fetching all session rows and aggregating in memory, which
  // is significantly faster for users with many chat sessions.
