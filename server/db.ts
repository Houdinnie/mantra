...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregate functions to avoid fetching all rows and aggregating in memory.
  // This reduces the operation complexity from O(N) to O(1) relative to the number of user sessions.
