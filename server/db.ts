...
/** Sets the database instance (useful for testing) */
...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregates to avoid fetching all sessions and aggregating in memory.
  // This reduces performance from O(N) where N is the number of sessions, to O(1) database query complexity.
