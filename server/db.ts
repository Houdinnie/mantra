...
/**
 * Used for testing to inject a mock database
 */
...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregate functions to avoid fetching all rows into memory.
  // Improves performance from O(N) to O(1) in terms of application memory and data transfer.
