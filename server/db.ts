...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregate functions (count, sum, max) to avoid fetching all rows.
  // This improves performance from O(N) to O(1) in the application layer.
