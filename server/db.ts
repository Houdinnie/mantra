...
export async function getUserStats(userId: number) {
  ...
  // Optimization: Use SQL aggregate functions to avoid fetching all sessions into memory.
  // This reduces memory usage and network bandwidth, especially for users with many sessions.
