...
export async function getUserStats(userId: number) {
  ...
  // Bolt: Optimized to use SQL aggregate functions to avoid fetching all sessions and aggregating in memory.
  // Changes time complexity from O(N) to O(1) for data transfer and processing.
