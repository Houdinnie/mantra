...
export async function getUserStats(userId: number) {
  ...
  // Optimized with SQL aggregate functions to avoid fetching all rows and aggregating in memory.
  // This reduces complexity from O(N) to O(1) in terms of data transfer and processing.
