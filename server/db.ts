...
export async function getUserStats(userId: number) {
  ...
  // Optimization: use SQL aggregate functions instead of fetching all sessions
  // This reduces memory usage and transfer time, especially for users with many sessions.
