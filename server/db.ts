...
export async function getUserStats(userId: number) {
  ...
  // Performance optimization: Use SQL aggregates instead of fetching all rows and aggregating in JS.
  // This reduces memory overhead and network transfer from O(N) to O(1).
