...
export async function getUserStats(userId: number) {
  ...
  // Optimized O(N) -> O(1) by leveraging database-level SQL aggregate functions (count, sum, max)
  // to avoid loading all rows into Node.js memory and doing the reduction/sorting.
