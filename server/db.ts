...
/**
 * Retrieves user chat statistics using SQL aggregate functions.
 * Optimization: Uses count(), sum(), and max() to perform aggregation at the database level,
 * reducing data transfer and memory usage from O(N) to O(1).
 */
