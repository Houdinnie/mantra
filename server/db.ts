...
export async function getUserStats(userId: number) {
  ...
  // Optimization: Use SQL aggregate functions to reduce network and memory overhead.
  // Instead of fetching all rows and aggregating in TypeScript, we let the database do the work.
