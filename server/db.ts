...
export async function getUserStats(userId: number) {
  ...
  // OPTIMIZATION: Query DB with SQL aggregate functions (count, sum, max)
  // to avoid loading and sorting all records in memory, transforming this from O(N) to O(1) database/memory overhead.
