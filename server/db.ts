...
/**
 * Bolt Optimization: Calculate user stats using SQL aggregates instead of in-memory processing.
 * This reduces memory usage and network overhead by letting the database handle the calculation.
 */
