...
/**
 * Optimized getUserStats using SQL aggregate functions.
 * Reduces memory usage and improves performance from O(N) to O(1) by offloading
 * aggregation to the database.
 */
