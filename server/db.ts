 ...
 * Replaces O(N) row retrieval and in-memory JS reduce/sort with SQL aggregate functions
 * (count, sum, max), reducing network payload and CPU/memory overhead from O(N) to O(1).
 */
