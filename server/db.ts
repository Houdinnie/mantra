...
export async function getUserStats(userId: number) {
  ...
  // Performance Optimization: Use SQL aggregate functions (count, sum, max) from drizzle-orm
  // to avoid fetching all rows and aggregating in memory, providing an O(N) to O(1) performance win.
