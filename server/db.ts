...
export async function getUserStats(userId: number) {
  ...
  // ⚡ Optimization: Use SQL aggregates instead of fetching all rows and aggregating in JS.
  // This avoids O(N) memory and network overhead for large session counts.
