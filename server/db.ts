...
export async function getUserStats(userId: number) {
  ...
  // Bolt optimization: Use SQL aggregate functions to avoid fetching all sessions and aggregating in memory
  // This significantly improves performance for users with large chat histories.
