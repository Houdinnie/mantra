...
/**
 * ⚡ Bolt Optimization: Aggregates stats directly in SQL database using count(), sum(), max().
 * Reduces network bandwidth and latency from O(N) row data transfer to O(1) single-row summary.
 */
