...
export async function getUserStats(userId: number) {
  ...
  // BOLT OPTIMIZATION: Use SQL aggregate functions instead of fetching all sessions and calculating in-memory.
  // This reduces O(N) data transfer/memory to O(1) for users with many chat sessions.
