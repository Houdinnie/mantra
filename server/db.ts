...
/**
 * For testing purposes: allows mocking the database instance
 */
...
export async function getUserStats(userId: number) {
  ...
  // Optimized to use SQL aggregate functions instead of in-memory aggregation.
  // This reduces data transfer and memory usage, especially for users with many sessions.
