...
export async function getUserStats(userId: number) {
  ...
  // Bolt Optimization: Use SQL aggregates (count, sum, max) from drizzle-orm to avoid fetching all sessions into memory.
  // This improves performance from O(N) to O(1) in terms of data transfer and memory usage.
