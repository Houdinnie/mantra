...
/**
 * Optimized version of getUserStats that uses SQL aggregate functions.
 * Changes complexity from O(N) to O(1) in terms of data transfer and server-side memory.
 */
