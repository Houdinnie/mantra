...
export async function getUserStats(userId: number) {
  ...
  // ⚡ Optimization: Use SQL aggregate functions instead of fetching all rows
  // This reduces memory usage and network transfer by processing data on the database server.
