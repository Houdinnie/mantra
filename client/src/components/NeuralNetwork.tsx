...
export default function NeuralNetwork({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // If the component is not active/visible, return early without scheduling
      // another requestAnimationFrame. This completely pauses background canvas rendering,
      // saving significant CPU cycle overhead.
      if (!isActive) {
