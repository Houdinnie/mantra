...
const PILLARS = [
  ...
  },
  {
    ...
    icon: "💰",
    color: "#ffd700",
    desc: "NHR, treaty, entity structuring",
  },
  {
    id: "legal",
    name: "Entity Lawyer",
  ...
  },
  {
    ...
    icon: "🏥",
    color: "#00ffcc",
    desc: "Health, longevity, insurance",
  },
  {
    id: "luxury",
            ...
            digest
              ...
              .map((line, i) => (
                <p
                  ...
                  className={
                    line.startsWith("##")
                      ? "text-cyan-400 font-bold text-xs mt-2"
                      : line.startsWith("###")
                        ? "text-slate-400 font-semibold text-xs mt-1"
                        : line.startsWith("🔴")
                          ? "text-red-400"
                          : line.startsWith("🟡")
                            ? "text-amber-400"
...
function PresenceGauge() {
  ...
  const riskColor =
    risk === "High" ? "#ff4444" : risk === "Medium" ? "#ffaa00" : "#00ff88";
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `radial-gradient(circle at 50% 0%, ${pillar.color}, transparent 70%)`,
        }}
      />
      ...
      <div className="flex items-center gap-4 mb-5">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-xs text-cyan-300"
          >
            # Channels
          </button>
          <button
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-xs text-green-400"
          >
            <Terminal className="w-3.5 h-3.5" /> Sandbox
          </button>
          <button
            onClick={() => navigate("/tasks")}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-xs text-cyan-400"
          >
            <Zap className="w-3.5 h-3.5" /> Tasks
          </button>
          <button
            onClick={() => navigate("/brain")}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-xs text-violet-400"
          >
            <Brain className="w-3.5 h-3.5" /> Brain
          </button>
          <button
            onClick={() => navigate("/app")}
            className="px-4 py-1.5 bg-cyan-600 hover:bg-cyan-500 rounded-lg text-xs font-semibold"
          >
            Open Chat →
          </button>
        </div>
      ...
      >
        ...
        <div className="col-span-3 flex flex-col gap-4 min-h-0">
          ...
          <div className="flex-1 min-h-0">
            <ActivityFeed
              onSelectSession={id => {
                sessionStorage.setItem("mantra_session", id);
                navigate("/app");
              }}
            />
          </div>
